<template>
    <div>
        ...
        <div class='reply-m' style='margin-left: 40px'>
    ...
    methods: {
        get_detail() {
            ...
            axios.get(this.topic_detail_link).then(res => {
                ...
                // this.group_lista = group(datas.replys)
                // this.page_num = this.group_lista.length
                // this.replys = this.group_lista[this.groupIndex]
                // this.all_reply = datas.replys
        ...
        //         const bottom = d.clientHeight
        //         const all = d.scrollHeight
        //         if (top + bottom == all && that.groupIndex < that.page_num - 1) {
        //             that.groupIndex += 1
        //             const next_page = that.group_lista[that.groupIndex]
        //             that.replys = that.replys.concat(next_page)
